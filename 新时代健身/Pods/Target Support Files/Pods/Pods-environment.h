...
// DCStarScoreView
#define COCOAPODS_POD_AVAILABLE_DCStarScoreView
#define COCOAPODS_VERSION_MAJOR_DCStarScoreView 1
#define COCOAPODS_VERSION_MINOR_DCStarScoreView 0
#define COCOAPODS_VERSION_PATCH_DCStarScoreView 0
